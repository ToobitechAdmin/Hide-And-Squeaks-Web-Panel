                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                ...
                                <form id="kt_modal_export_users_form" class="form"
                                    action="{{ route('audios.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body px-5 my-7">
                                <!--begin::Form-->
                                <form id="kt_modal_add_user_form" class="form" action="{{ route('audios.store') }}"
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <form action="{{ route('audios.edit', $audio->id) }}" method="get"
                                    style="display:inline">
                                    @csrf
