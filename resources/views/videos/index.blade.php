...
<div class="card">
    ...
    <div class="d-flex align-items-center position-relative my-1">
        ...
        <input type="text" id="userSearchInput" class="form-control form-control-solid w-250px ps-13" placeholder="Search Video" />
    </div>
    <!--end::Search-->
        </div>
    ...
    <tbody class="text-gray-600 fw-semibold">
                ...
                <tr>
                  <td>
                    ...
                    <td>{{ $videos->title }}</td>
                    <td>
                       <a href="#" class="video-link" data-src="{{ asset('storage/' . $videos->file_path) }}">Watch Video</a>
                ...
                {{-- <a href="{{ asset('storage/' . $videos->file_path) }}" download>Download</a> --}}
                    ...
                    <td class="actions">
                        <form action="{{ route('videos.destroy', $videos->id) }}" method="post" style="display:inline">
                            @csrf
                            @method('DELETE')
<button type="submit" style="background-color: #a932ff; color: #ffffff; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; font-size: 16px;" onmouseover="this.style.backgroundColor='#7d3aaf'" onmouseout="this.style.backgroundColor='#a932ff'">Delete</button>
                    ...
                    <td class="actions">
                        <form action="{{ route('videos.edit', $videos->id) }}" method="get" style="display:inline">
                            @csrf
