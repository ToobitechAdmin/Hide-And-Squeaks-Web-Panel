    ...
    @section('breadcrumbs')
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('videos.index') }}">Video Management</a></li>
                ...
                <div class="card-body py-4 mx-20">
                    ...
                    <form action="{{ route('videos.update', $videos->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2">Video File</label>
                            <!--end::Label-->

                            <!--begin::Input-->
                            <input type="file" name="video_file" class="form-control form-control-solid mb-3 mb-lg-0" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <input type="text" name="title" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter Title" value="{{ $videos->title }}" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
